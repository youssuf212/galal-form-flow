...
const GeometricBackground = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="geometric-shape delayed-2 top-20 right-1/4" 
           style={{
             width: 0,
             height: 0,
      ...
      <div className="geometric-shape delayed-3 bottom-10 left-1/3" 
           style={{
             width: 0,
             height: 0,
...
const MembershipForm = () => {
  ...
  return (
    <div className="min-h-screen geometric-bg bg-background flex items-center justify-center p-4">
      <GeometricBackground />
      
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">Galal Academy</h1>
          <p className="text-muted-foreground text-lg">Membership Application</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="form-field">
              ...
              <input
                ...
                onChange={(e) => handleInputChange("youtubeName", e.target.value)}
                className="form-input"
                placeholder="Your YouTube channel name"
                disabled={isSubmitting}
              />
              {errors.youtubeName && (
                <p className="text-destructive text-sm">{errors.youtubeName}</p>
              )}
            </div>
            ...
            <div className="form-field">
              ...
              />
              {errors.gmail && (
                <p className="text-destructive text-sm">{errors.gmail}</p>
              )}
            </div>
            ...
            <div className="form-field">
              ...
              <textarea
                ...
                placeholder="Share any suggestions or comments (optional)"
                disabled={isSubmitting}
              />
            </div>
